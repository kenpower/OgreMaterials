...
void OgreApp1::createScene(void)
{
	...
	Ogre::MaterialPtr mat = Ogre::MaterialManager::getSingleton().load("MyMaterials/Diffuse", Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME);
	
	ogreHead->setMaterial(mat);
